...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "preston is so sexy and hot and perfect and awesome", NULL, NULL);
    if (window == NULL)
    {
    ...
    // load and create a texture1 (liesl)
    // -------------------------
